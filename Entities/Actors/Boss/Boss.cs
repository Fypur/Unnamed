...
namespace Platformer
{
    public class Boss : Actor
    {
        ...
        public Boss(Vector2 position) : base(position, 32, 32, constGravityScale, new Sprite(Color.Red))
        {
            ...
            StateMachine.SetStateFunctions(States.Walking, () => Walking(null), null, () => Velocity.X = 0);
            StateMachine.SetStateFunctions(States.Jumping, JumpUp, null, null);
            StateMachine.SetStateFunctions(States.Missiling, Missiling, null, null);
            StateMachine.SetStateFunctions(States.WallMissiling, Missiling, null, null);
            StateMachine.SetStateFunctions(States.JumpDown, JumpDown, null, null);
            StateMachine.SetStateFunctions(States.MachineGun, () => AddComponent(new Coroutine(MachineGun())), null, null);
            StateMachine.SetStateFunctions(States.Swipe, () => AddComponent(new Coroutine(Swipe())), null, null);
