...
This game was built on Monogame, using my own engine [Fiourp](https://github.com/fypur/fiourp) built on top of it. The levels were built using [LDtk](htttps://ldtk.io) and it's implementation in Monogame called [LDtkMonogame](https://github.com/IrishBruse/LDtkMonogame). I've used [Aseprite](https://www.aseprite.org/) to make pixel art.
The game is very much inspired by Celeste, Hollow knight and the ori games.
